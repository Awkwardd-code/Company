          ...
          <div className="lg:col-span-2">
            <div className="bg-gray-900/80 rounded-xl border border-gray-700/50 p-8">
              <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Building a Modern Web App: A Comprehensive Guide
              </h1>
              ...
              <div className="prose prose-invert max-w-none text-gray-300">
                ...
                <div className="bg-black/30 rounded-lg p-4 my-4 text-sm">
                  <p className="text-gray-300">const app = express();</p>
                  <p className="text-gray-300">app.use(express.json());</p>
                  <p className="text-gray-300">app.listen(3000, () = console.log('Server running'));</p>
                </div>
                <p>
