    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0f] transition-colors duration-300">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <motion.div
          ...
          className="bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-white py-12 px-6 sm:px-8 lg:px-12 flex flex-col lg:flex-row items-center justify-between rounded-xl mb-16 transition-all duration-300 shadow-lg hover:shadow-xl"
        >
          <div className="transform transition-transform duration-300 hover:scale-[1.01]">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-3 text-base lg:text-lg max-w-2xl">
              Explore our collection of tutorials and insights from industry experts.
            </p>
          </div>
          <button className="mt-6 lg:mt-0 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105">
            Start Exploring
          </button>
        </motion.div>
