...
const ModalSearch: React.FC<ModalSearchProps> = ({ id, searchId, modalOpen, setModalOpen }) => {
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 16 16"
                    >
                      <path d="M3 2a1 1 0 011-1h8a1 1 0 011 1v12a1 1 0 01-1 1H4a1 1 0 01-1-1V2z" />
                    </svg>
