...
} & React.HTMLAttributes<HTMLDivElement>; // Add this to allow className and other HTML attributes

const ChatBubble = ({ me, message, previousMessage, className = "", ...rest }: ChatBubbleProps) => {
  ...
  return (
    <>
      <DateIndicator message={message} previousMessage={previousMessage} />
      <div className={`flex gap-1 w-2/3 ml-auto ${className}`} {...rest}>
        <div
...
const ImageDialog = ({
  ...
  >
    <DialogContent className="min-w-[750px] z-[99999]">
